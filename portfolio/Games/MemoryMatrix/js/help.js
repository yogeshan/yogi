...
function startInstruction(){
    ...
    if(GAME_STOP){
        ...
        $('.help-msg').html('Now you will be shown white blocks. <a href="#" class="close-help-first">Next <img src="icons/temp/arrow-69-16.png" /></a>');
...
function showHelper(){
    ...
    $('.container_g .col-help.right').addClass('active').css('background','white');
    
    $('.help-msg').html('<a href="#" class="close-help-second">Next <img src="icons/temp/arrow-69-16.png" /></a>Now you have to remember the white blocks. ');
}
...
$('.close-help-second').live('click',function(){
    ...
    $('.container_g .col-help.right').removeClass('active').css('background','lime');
...
$('.helper-1.ready').live('click',function(){
    ...
    $(this).addClass('active').removeClass('ready').css('background','white');
// change position
});
...
$('.helper-2.ready').live('click',function(){
    ...
    $('.help-msg').html('Congratulations! you have learnt how to play Memory Matrix. <br><br><span onclick="startInstruction();">Play again</span> <span class="home">Home</span>');
});
var col_help;
$('.col-help.wrong.ready').live('click',function(){
    col_help=$(this);
    col_help.addClass('active').css('background','red');
    setTimeout("col_help.removeClass('active').css('background','lime');",300);
    // change position
